...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('flagrow-passport', function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_LogInButtons__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'items', function (items) {
    items.add('flagrow-passport', m(flarum_components_LogInButton__WEBPACK_IMPORTED_MODULE_3___default.a, {
      className: "Button LogInButton--passport",
      icon: "id-card-o",
      path: "/auth/passport"
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('flagrow.passport.loginTitle')));
  });
});
